[![Build Status](https://dev.azure.com/aldor-i/Flask/_apis/build/status/aldor-i.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/aldor-i/Flask/_build/latest?definitionId=1&branchName=master)
